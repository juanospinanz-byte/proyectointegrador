...
CREATE TABLE IF NOT EXISTS productos (
  ...
  disponible      BOOLEAN DEFAULT TRUE,                    -- Si el producto está disponible
...
INSERT INTO productos (nombre, descripcion, precio, imagen_url, caracteristicas, disponible) VALUES
(
